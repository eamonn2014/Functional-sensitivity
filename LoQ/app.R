                 ...
                 sidebarLayout(
                   ...
                   sidebarPanel( width=3,
                                 ...
                                 div(
                                   ...
                                   splitLayout(
                                     textInput('sigma1', 
                                               div(h5(tags$span(style="color:blue", "Residual error"))), ".4"),
                         ...
                         if your data columns have names. 
                          The top two radio button options are to help load. Of course only the 'Analysis transformation' radio buttons are needed. Here is a link to example data (download a file and click 'Browse...' to locate and upload for the analysis):")) ,
                               ...
                               tabPanel("10 Wiki", value=3, 
                                        ...
                                        h4("Now we describe the contents of the data listing tab: X is uniform(N,0,100) and y is then derived from the user
                                        ...
                                        h4(paste("* Convert main plot to plotly.")),
                                         h4(paste("* Known issue, the R code line printed below used in the loq1 function will sometimes cause 'Warning: Error in unit: 'x' and 'units' must have length > 0' and no plot will be displayed. 
                                                  However, enter a Y read back value and a plot will appear. So some read back values cause the error when the log transformation plot is requested. 
                                                  This line can be removed to eliminate the error, but the drawback then is the log ticks are removed!")),
